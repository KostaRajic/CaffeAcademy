...
export const CoffeeMenu = () => {
    ...
    return <section className='coffee-menu-section'>
        ...
        <div className='coffee-cart'>
            ...
            <div>
                <img src={cupOfCoffee} alt='Cup of coffee' />
                <h2 style={{ width: '80px', height: '40px' }}>Esspreso dugi</h2>
            ...
            <div>
                <img src={cupOfCoffee} alt='Cup of coffee' />
                <h4 className='affogato-class'>Affogato</h4>
            ...
            <div>
                <img src={cupOfCoffee} alt='Cup of coffee' />
                <h2>Affogato <br />sa sladoledom</h2>
            ...
            <div>
                <img src={cupOfCoffee} alt='Cup of coffee' />
                <h2>Turkish Coffee <br />sa mlekom</h2>
            ...
            <div>
                <img src={cupOfCoffee} alt='Cup of coffee' />
                <h2>Ice Coffee <br />sa sladoledom</h2>
